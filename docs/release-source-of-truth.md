...
- Mobile menu anchors complete native navigation before the route/hash change closes the menu; iOS short taps use the guarded touch fallback with drag rejection and duplicate-click suppression.
