...
- The mobile menu toggle and anchors use the guarded iOS short-tap fallback with drag rejection and duplicate-click suppression; anchors still complete navigation before the route/hash change closes the menu.
