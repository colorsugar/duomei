...
const xinshuoTwoPageDescriptions = [
  ...
  "小纸船接走困在叶子上的蚁蚁。两名学生用纸船帮助叶片上的蚁蚁渡过积水。",
  ...
  "一根犹豪的红线，让奔跑的人停下来看。学生跪在操场边画红线，两名同学好奇围观。",
  "安静的一根线，变成全操场的彩色道路。许多学生在操场共同绘制巨大的彩虹道路。",
  "短雨把粉笔画冲开，颜色开始自己流动。学生们在太阳雨中用叶片引导流动的彩色水痕。",
  "被冲淡的画，又被更多双手重新画亮。学生举起最后一截红粉笔，大家共同重画彩虹路。",
  "月亮石、纸船和红粉笔被放在书桌上。穿条纹睪衣的学生整理书包里的月亮石、纸船和粉笔。",
  "屋里很安静，月亮石却在床边轻轻发光。学生躺在床上望着床头发光的浅蓝色月亮石。",
  "枕头下面露出一小块太阳和白云。学生掠开枕头一角，看见温暖的太阳光。",
  "房间装不下的白天，流进了无边梦境。学生掠开枕头，白昼风景流入布满鲸鱼和云朵的梦境。",
