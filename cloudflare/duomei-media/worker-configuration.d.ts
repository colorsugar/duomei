/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 864209326d7c4e0094e6aee85b4be8c8)
// Runtime types generated with workerd@1.20260811.1 2026-08-13
interface __BaseEnv_Env {
	DUOMEI_MEDIA: R2Bucket;
	DUOMEI_PRIVATE: R2Bucket;
	SUPABASE_URL: "https://bokvqndvwqgugkcrizwj.supabase.co";
	SUPABASE_PUBLISHABLE_KEY: "sb_publishable_WONhLBnVl1ea_sroDggFAw_FuTZlZFX";
	GUYU_MEDIA_SIGNING_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "GUYU_MEDIA_SIGNING_SECRET">> {}
}
