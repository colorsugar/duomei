...
$poetryBundle = @(
  ...
  "src/experience/MotionHero.tsx",
  "src/experience/MotionChapters.tsx",
  "src/experience/MotionPlans.tsx",
  "src/experience/motionRenderer.ts",
  "src/experience/xianyouTimeline.ts",
  "src/experience/xianyouTimeline.test.ts",
  "src/experience/motion-proposals.css",
  "src/experience/CinematicRouteTransition.tsx",
  "src/experience/routeMotion.ts",
  "public/experience/sword-v4.webp",
  "public/experience/sword-key-v4.webp",
  "public/experience/mountains-v4.webp",
  "public/experience/journey-v4.webp",
  "public/experience/reading-v4.webp",
  "public/experience/xianyou-assets.json",
  "docs/xianyou-candidate.md",
