...
$poetryBundle = @(
  ...
  "src/components/XunjiSection.tsx",
  "src/components/XunjiSection.css",
  "src/pages/DuomeiXunjiPage.tsx",
  "src/pages/DuomeiXunjiArchivePage.tsx",
  "server/xunjiProxy.mjs",
  "server/xunjiProxy.test.mjs",
  "edge-functions/xunji.js",
  "edge-functions/xunji/[[default]].js",
  "edge-functions/xunji-src.js",
  "edge-functions/xunji-src/[[default]].js",
